...
class LoginView extends React.Component {
  constructor() {
    ...
    this.state = {
      ...
      isSignUpFullNameEmpty: null,
      isSignUpEmailEmpty: null,
      isSignUpPaswordEmpty: null,
      isSignUpEmailInValid: null,
      first_name: "",
      email: "",
      password: "",
      errors: {}
  ...
  validateLoginFormAndSubmit() {
    let isLoginUserNameEmpty = true,
      isLoginPasswordEmpty = true;
          ...
          {this.props.signUpCondition ? (
            <div className="w-100">
              <form className="col-12 col-xl-4 col-lg-6 col-md-8 col-sm-10 signupArea offset-xl-4 offset-lg-3 offset-md-2 offset-sm-1">
                <h1 className="slide-design-header mb-5 text-center">
                  Create Account
                </h1>
                {this.props.message && (
                  <span className="slide-design-a" style={{ color: "red" }}>
                    {this.props.message}
                  </span>
                )}
                ...
                <div
                  className={
                    this.props.signUpFailed
                      ? "input-group login-failed-border mt-3"
                      : "input-group mt-3"
                  }
                >
                ...
                {this.state.errors.name && (
                  <div className="alert text-danger w-100 text-left m-0 p-0">
                    <i className="fa fa-warning"></i> {this.state.errors.name}
                  </div>
                )}
                ...
                >
                  ...
                  <input
                    ...
                    className={
                      this.props.signUpFailed
                        ? "form-control login-failed-border"
                        : "form-control"
                    }
                    type="email"
                    placeholder="Email"
                ...
                {this.state.errors.email && (
                  <div className="alert text-danger w-100 text-left m-0 p-0">
                    <i className="fa fa-warning"></i> {this.state.errors.email}
                  </div>
                )}
                ...
                <button
                  ...
                  onClick={e => {
                    e.preventDefault();
                    this.validateSignUpFormAndSubmit();
                  }}
                >
                  Sign up
                </button>
                ...
                {this.props.signUpFailed && (
                  <div className="alert text-danger w-100 text-left m-0 p-0">
                    <i className="fa fa-warning"></i> Sign up error! Try again
                  </div>
                )}
                ...
                <button
                  ...
                  onClick={e => {
                    e.preventDefault();
                    this.props.handleSignUpCondition();
                  }}
                >
                  Login now!
                </button>
            ...
            <div className="w-100">
              <form className="col-12 col-xl-4 col-lg-6 col-md-8 col-sm-10 loginArea offset-xl-4 offset-lg-3 offset-md-2 offset-sm-1">
                {this.props.message ? (
                  <h1 className="slide-design-header mb-5">
                    {this.props.message}
                  </h1>
                ) : (
                  <h1 className="slide-design-header mb-5 text-center">
                ...
                <div
                  className={
                    this.props.login_failed
                      ? "input-group login-failed-border"
                      : "input-group"
                  }
                >
                  <div className="input-group-prepend">
                ...
                {this.state.isLoginPasswordEmpty && (
                  <div className="alert text-danger w-100 text-left m-0 p-0">
                    <i className="fa fa-warning"></i> Password is required
                  </div>
                )}
                ...
                <button
                  ...
                  onClick={e => {
                    e.preventDefault();
                    this.validateLoginFormAndSubmit();
                  }}
                >
                  Login
                </button>
                ...
                {this.props.login_failed && (
                  <span className="alert text-danger w-100 text-left m-0 p-0">
                    <i className="fa fa-warning"></i> Invalid credentials
                  </span>
                )}
                <a className="mt-2 forgotPassword" href="#">
